...
public class CK2MapToolsUI extends JFrame implements PropertyChangeListener, ActionListener, WindowListener {
	...
	private JCheckBox chkBxLocalisation;
	...
	public CK2MapToolsUI() {
		...
		chkBxLocalisation = new JCheckBox("Localisation");
		chkBxLocalisation.setSelected(true);
		chkBxLocalisation.setFont(new Font("Tahoma", Font.PLAIN, 11));
		chkBxLocalisation.setBounds(10, 94, 150, 23);
		panelOptionsSetup.add(chkBxLocalisation);
		...
		case MAKE_SETUP:
	
			{
				CK2MakeProvinceSetup t = new CK2MakeProvinceSetup();
					...
					t.setParamMakeLocalisation(chkBxLocalisation.isSelected());
